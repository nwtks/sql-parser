...
- **Types**: Full SQL type system including `VARCHAR`, `NUMERIC`, `TIMESTAMP WITH TIME ZONE`, `INTERVAL`, `ARRAY`, `REF(...)`, `ROW`, nested collections (`INT ARRAY ARRAY`, `INT MULTISET ARRAY[3]`), etc.
